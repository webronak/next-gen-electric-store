  ...
  render() {
    return (
      <div className="navbar">
        ...
        <ul
          className={
            this.state.toggle ? "navLinks toggle-navLinks" : "navLinks"
          }
        >
          <Link to="">
            <li onClick={() => this.setState({ toggle: false })}>Home</li>
          </Link>
          <Link to="/products/sockets">
            <li onClick={() => this.setState({ toggle: false })}>Products</li>
          </Link>
          <Link to="/contact">
            <li onClick={() => this.setState({ toggle: false })}>Contact</li>
          </Link>
          <Link to="/about">
            <li onClick={() => this.setState({ toggle: false })}>About</li>
          </Link>
        </ul>
          ...
          <button id="cart" onClick={() => this.props.setCartToggle()}>
            ...
            {this.props.totalCartItemsQuantity > 0 ? (
              <span className="countDisplay">
                <small>{this.props.totalCartItemsQuantity}</small>
              </span>
            ) : (
              ""
            )}
...
const mapStateToProps = (state) => ({
  ...
  totalCartItemsQuantity: state.cart.cartItems
